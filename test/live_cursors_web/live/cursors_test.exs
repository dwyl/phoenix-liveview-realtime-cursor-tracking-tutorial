defmodule LiveCursorsWeb.CursorsTest do
  ...
  @presence_list_response %{
    "phx-FyEJCOx5vtCG6QAl" => %{
      metas: [
        %{
          color: "#035CA5",
          phx_ref: "FyEJCe_cOATybwvh",
          phx_ref_prev: "FyEJCe9jBIPybwvB",
          socket_id: "phx-FyEJCOx5vtCG6QAl",
          username: "tibet-nebula",
          x: 40.682870370370374,
          y: 23.435722411831627
        }
      ]
    }
  }
  @presence_getByKey_response %{
    metas: [
      %{
        color: "#5CC1CE",
        phx_ref: "FyEKNvTsug53WgpD",
        phx_ref_prev: "FyEKNvRCfsp3Wgoj",
        socket_id: "phx-FyEKNeF1WxLc6gAj",
        username: "gamma-boston",
        x: 72.68518518518519,
        y: 11.945392491467576
      }
    ]
  }
  ...
  describe "Mount state" do
    ...
    test "when mouse changes", %{socket: _socket} do
      with_mock LiveCursorsWeb.Presence,
        ...
        update: fn _self, _topic, _key, _metas -> :ok end do
